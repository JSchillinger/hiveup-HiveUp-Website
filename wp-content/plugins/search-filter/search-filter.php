	...
	class SearchAndFilter
	{
		...
		*/
		...
		public function generate_wp_radio($args, $name, $currentid = 0, $labels = null, $defaultval = "0")
		{
			...
			$returnvar = '<ul>';
			$returnvar .= '<li class="cat-item">'."<label class='checkbox'><input type='radio' name='".$args['sf_name']."[]' value='0'$checked /> ".$show_option_all.'<span class="checkmark"></span>'."</label>".'</li>';
